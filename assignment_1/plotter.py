...
file = open("/home/atharva/syscon_ws/src/sc627_assignments/assignment_1/output_bug1.txt","r")
...
def plot_path():
    ...
    plt.xlim(-0.2,5.2)
    plt.ylim(-0.2,3.2)
    plt.savefig("/home/atharva/syscon_ws/src/sc627_assignments/assignment_1/bug1_plots/traversed_path.png")
    plt.show()
...
def plot_distogoal():
    ...
    plt.grid(True)
    plt.savefig("/home/atharva/syscon_ws/src/sc627_assignments/assignment_1/bug1_plots/distance_to_goal.png")
    plt.show()
